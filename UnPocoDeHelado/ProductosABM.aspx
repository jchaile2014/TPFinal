    ...
    <div class="container mt-5">
        <div class="row"><div class="col-md-6 offset-md-3">
            ...
            <div class="mb-3"><label class="form-label">Cantidad (stock)</label>
                <asp:TextBox ID="txtCantidad" CssClass="form-control" TextMode="Number" runat="server"></asp:TextBox></div>
            <div class="mb-3"><label class="form-label">Stock mínimo</label>
                <asp:TextBox ID="txtStockMinimo" CssClass="form-control" TextMode="Number" runat="server"></asp:TextBox></div>
            <div class="mb-3"><label class="form-label">% Ganancia</label>
                <asp:TextBox ID="txtPorcentaje" CssClass="form-control" TextMode="Number" runat="server"></asp:TextBox></div>
            <div class="mb-3"><label class="form-label">Precio compra</label>
                <asp:TextBox ID="txtPrecioCompra" CssClass="form-control" TextMode="Number" runat="server"></asp:TextBox></div>
            ...
            <div class="mb-3">
                ...
                <asp:Button ID="btnEliminar" CssClass="btn btn-danger fw-bold" style="border-radius: 12px;" Text="Inactivar" runat="server" OnClick="btnEliminar_Click" Visible="false" />
                <asp:Button ID="btnCancelar" CssClass="btn btn-light fw-bold" style="border: 2px solid #ff7eb3; color: #ff7eb3; border-radius: 12px;" Text="Cancelar" runat="server" OnClick="btnCancelar_Click" />
            </div>
        </div></div>
    </div>
</asp:Content>
