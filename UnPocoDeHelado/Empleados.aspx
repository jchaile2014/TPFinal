...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container mt-4">
        ...
        <div class="kpi-strip mb-4">
            <div class="kpi-item" id="kpiTodas">
                <i class="bi bi-person-badge kpi-icon" style="color:#ff7eb3;"></i>
                <div>
        ...
        <div id="sinResultados" class="text-center py-5" style="display:none;">
            ...
            <p class="text-muted mt-3 fw-semibold">No se encontraron empleados con ese criterio.</p>
        ...
        <div class="row" id="gridEmpleados">
            <asp:Repeater ID="repEmpleados" runat="server" OnItemCommand="repEmpleados_ItemCommand">
                <ItemTemplate>
                    <div class="col-md-4 col-sm-6 mb-4 empleado-card-wrapper"
    ...
    <style>
        ...
        .empleado-card-wrapper.hidden { display: none !important; }
        @keyframes fadeInUp {
    ...
    <script type="text/javascript">
        ...
        function aplicarFiltros() {
            ...
            var cardsWrapper = document.getElementById('gridEmpleados');
            var cards = Array.from(document.querySelectorAll('.empleado-card-wrapper'));
        ...
        function actualizarContadores() {
            var total = document.querySelectorAll('.empleado-card-wrapper').length;
